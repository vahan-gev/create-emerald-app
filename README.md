...
Get up and running with Emerald in seconds! Choose your preferred installation method:

### 📦 NPM Installation (Recommended)

```bash
npm install -g create-emerald-app
```

### Create Your First Game

```bash
# Create a new Emerald game
create-emerald-app my-awesome-game
...
```bash
yarn global add create-emerald-app
```
...
```bash
pnpm add -g create-emerald-app
```

</details>

<details>
<summary><strong>One-time use with npx</strong></summary>

```bash
npx create-emerald-app my-game
```
