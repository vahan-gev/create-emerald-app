import { STANDARD_FRAGMENT_SHADER, STANDARD_VERTEX_SHADER } from "./Shaders";
...
class Emerald {
  ...
  drawScene(scene, deltaTime) {
    ...
    this.gl.clearColor(
      Emerald.backgroundColor.r,
      Emerald.backgroundColor.g,
      Emerald.backgroundColor.b,
      Emerald.backgroundColor.a
    );
