import { initVertexBuffer, initInstancedBuffer } from "./GLUtils";
import Instance from "./Instance";
import Drawable from "./Drawable";
import { mat4 } from "gl-matrix";
import GLManager from "./managers/GLManager";
      ...
      if (rigidBody) {
        if (rigidBody.getType() === "dynamic") {
          ...
          instance.transform.position.y =
            ...
            rigidBodyOffset.y;
          if(collider) {
            collider.debugShape.gameObject.transform.position.x = instance.transform.position.x;
            collider.debugShape.gameObject.transform.position.y = instance.transform.position.y;
          }
        }
      }
    }
