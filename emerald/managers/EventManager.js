...
class EventManager {
  ...
  /**
   * @method addMouseMove
   * @description Adds a mouse move event listener
   * @param {function} func - The function to call when the mouse moves
   */
  addMouseMove(func) {
    this.mouseMoveListeners.add(func);
  }

  /**
   * @method removeMouseMove
   * @description Removes a mouse move event listener
   * @param {function} func - The function to remove
   */
  removeMouseMove(func) {
    this.mouseMoveListeners.delete(func);
  }
  ...
  handleMouseMove(event) {
    ...
    // Call registered mouse move listeners
    this.mouseMoveListeners.forEach((func) => func(event, worldX, worldY));
   ...
   * @description Updates the cached canvas dimensions when the canvas is resized
